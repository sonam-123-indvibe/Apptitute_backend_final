...
const aiEvaluateController = require("../controllers/aiEvaluateController");
...
// 3. AI Evaluate (written answers scored out of 10 by Gemini AI)
router.post("/ai-evaluate", auth, aiEvaluateController.aiEvaluate);

// 4. Manual Send Result (Optional)
